...
import SearchModal from '../sections/SearchModal.jsx';
      ...
      >
        ...
        <div className="md:flex items-center gap-4 hidden">
          {isProductRoute && (
            <div>
              {count > 0 && (
                <span className="top-[-10px] text-xs p-[10px] relative  float-right bg-red-500 text-white rounded-full w-4 h-4 flex justify-center items-center">
                  {" "}
                  {count}
                </span>
              )}
